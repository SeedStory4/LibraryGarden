 ...
 */
	...
	// 희망 도서 목록 페이지 이동(팝업)
	@ResponseBody
	@RequestMapping(value="/bookRequestList.do")
	//public JSONObject bookRequestList(@RequestParam("id") String id) {  
	//public ResponseEntity<String> bookRequestList(@RequestParam(value = "searchType", required = false) String searchType,  // 자바의 request.getParameter("searchType"); 대체
	public HashMap<String, Object> bookRequestList(
			@RequestBody SearchCriteria scri
			) {
