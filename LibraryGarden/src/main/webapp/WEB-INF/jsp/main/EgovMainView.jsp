  ...
  <table>
    ...
    <tbody>
      ...
      <%-- <tr>
        ...
        <td rowspan="5">DirectorApprovalController</td>
      </tr>
      <tr>
        <td>기안 등록</td>
        <td><a href="${pageContext.request.contextPath}/admin/directorApproval/directorApprovalWrite.do">directorApprovalWrite</a></td>
      </tr>
      <tr>
        <td>기안 상세</td>
      ...
      <tr>
        <td>기안 수정</td>
        <td><a href="">directorApprovalModify</a></td>
      </tr>
      <tr>
        <td>반려사유 팝업</td>
