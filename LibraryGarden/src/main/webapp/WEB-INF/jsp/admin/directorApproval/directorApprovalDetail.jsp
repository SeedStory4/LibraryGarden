			...
			<section class="section">
				...
				<form name="frm">
					<div class="draft-actions mg-top">
						<a href="${pageContext.request.contextPath}/admin/directorApproval/${aidx}/directorApprovalModify.do" class="draft-btn-small btn-submit flex align-center justify-center">수정</a>
