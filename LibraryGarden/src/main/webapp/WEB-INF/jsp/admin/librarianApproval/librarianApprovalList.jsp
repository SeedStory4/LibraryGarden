...
<body class="custom-page">
	...
	<div class="wrapper">
		<section class="section p-0">
			<h2 class="section-title m-0 normal relative">결재관리 목록<a class="btn btn-primary absolute" href="${pageContext.request.contextPath}/admin/librarianApproval/librarianApprovalWrite.do">기안등록</a></h2>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="${pageContext.request.contextPath}/admin/librarianApproval/${ad.aidx}/librarianApprovalDetail.do">${ad.title}</a></td>
									<td>${ad.author}</td>
									<td>${ad.publisher}</td>
