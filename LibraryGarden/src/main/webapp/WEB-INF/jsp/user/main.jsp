	...
	<div class="wrapper">
			<section class="book-section">
			  ...
			  <div class="book-list">
			    ...
			    <c:if test="${not empty topLoanBooks}">
			    ...
			    <c:if test="${empty topLoanBooks}">
			      <div class="no-data">이번 달 대출 순위가 없습니다.</div>
			    </c:if>
			...
			<section class="book-section">
			  ...
			  <div class="book-list">
			    ...
			    <c:if test="${empty latestBooks}">
			      <div class="no-data">이달의 신간이 없습니다.</div>
			    </c:if>
