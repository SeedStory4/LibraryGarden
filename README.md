...
"사용자 중심의 UI/UX, 도서 정보 자동 연동, 실시간 캘린더 예약 등 다양한 기능이 유기적으로 연결되어, 단순한 대출 시스템이 아닌 ‘함께 만들어가는 디지털 지식 
정원’이라는 새로운 경험을 제안합니다."			
...
#### 백엔드
![](https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white) ![](https://img.shields.io/badge/Spring-6DB33F?style=for-the-badge&logo=spring&logoColor=white) ![eGovFrame](https://img.shields.io/badge/eGovFramework-00599C?logo=spring&logoColor=white)
...
- 회원들의 도서 예약 목록을 확인할 수 있습니다. 제목, 서명/저자사항, 예약자로 검색을 할 수 있습니다.
- 취소버튼을 누르면 해당 예약이 취소됩니다.
