...
- 아이디 찾기 페이지입니다.
- 회원의 이름과 휴대전화번를 DB에서 조회후 아이디를 알려줍니다.
...
- 비밀번호 찾기 페이지입니다.
- 아이디와 휴대전화번를 DB에서 조회 후 가입시 입력한 이메일로 임시비빌번호를 발송합니다.
...
- 도서관 도서를 등록하는 페이지입니다.
- 도서를 등록하면 하단에 등록한 책 목록들이 나타나며 삭제 버튼을 클릭해서 도서를 삭제하거나 제목을 클릭해서 상세 페이지로 이동할 수 있습니다.
...
- 회원번호를 입력한 뒤 도서 제목을 클릭하면 회원번호를 입력한 사용자 도서를 예약할 수 있습니다.
...
- 수정 버튼을 클릭하면 수정 페이지로, 목록 버튼을 클릭하면 목록 페이지로 이동합니다.
- 삭제 버튼을 클릭하면 기안이 삭제됩니다.
- 도서관장이 승인/반려 버튼을 클릭해서 승인/반려를 합니다.(반려시 반려사유 입력 필요)
